...
def verificar_mision(arbol):
  ...
  tabla_de_simbolos.append(simbolo(arbol.hijos[1].token,arbol.hijos[1].token.value,"mision",arbol.hijos[1].token.lexpos,arbol.hijos[1].token.lineno,"global",tipo_de_mision))
...
def verificar_llamada_de_mision(arbol):
  ...
  nodo_mision=buscar_mision(ll1.arbolito,arbol.hijos[0].token.value)
...
def verificar_scope(arbol):
  ...
  if (arbol.elemento=="SentenciasYoyo" or arbol.elemento == "Sentencias") and arbol.hijos[0].elemento == "mostrar":
    verificar_mostrar(arbol)
  
  if (arbol.elemento=="SentenciasYoyo" or arbol.elemento == "Sentencias") and arbol.hijos[0].elemento=="lizquierdo":
    n=n+1
