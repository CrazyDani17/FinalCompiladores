...
print("#######################################################")
print ("Felicidades Programa Compilado :D")
print("#######################################################")
data = ".data\n\nendl: .asciiz " + '"' + "\\n" +'"' + "\n"
total = 0
parametros = []
...
def generar_codigo(arbol):
  ...
  if ((arbol.elemento=="SentenciasYoyo" or arbol.elemento == "Sentencias") and (arbol.hijos[0].elemento=="si" or arbol.hijos[0].elemento=="yoyo")) or arbol.elemento == "DeclaracionFuncion":
